// ai.js — Hive AI (minimax with alpha-beta)
...
function scoreMove(state, move, player) {
  // Prioritize queen placement, then moves that surround opponent queen
  if (move.type === 'place' && move.pieceType === 'queen') return 50;
